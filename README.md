...
- [`notebooks/LIDS_demo.ipynb`](notebooks/LIDS_demo.ipynb): a deeper walkthrough of the BERT-SVD algorithm, layer-by-layer comparisons, and a similarity matrix.
...
LIDS_similarity(text1, text2, k=30, alpha=1.0,
                singular_value_fraction=0.9999, max_length=512)
```
...
This repository implements the similarity-metric portion of the broader LIDS framework described in the accompanying research paper. The SOFARI key-word inference component is outside this package's current scope.
